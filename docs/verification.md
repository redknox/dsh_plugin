...
| #17 prebuilt artifact / npm prep | **published `llm-llamacpp@0.2.0`** (0.1.0 initial) (registry E2E: install, bundle reconcile, boot, provider active, remove/reinstall — `docs/release.md`) |
